...
const ToServerCommandHandler toServerCommandTable[TOSERVER_NUM_MSG_TYPES] =
{
  ...
  //{ "TOSERVER_AUTH_PLAIN",               TOSERVER_AUTH_PLAIN, &Server::handleCommand_AuthPlain } // 0x53
  { "TOSERVER_AUTH_PLAIN",               TOSERVER_STATE_NOT_CONNECTED, &Server::handleCommand_AuthPlain } // 0x53
};
